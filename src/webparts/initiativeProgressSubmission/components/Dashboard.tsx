                                        ...
                                        <div className={styles.CardBody}>
                                            ...
                                            <div>
                                                <div className="row px-3">
                                                    ...
                                                    <div className="col-6">
                                                        <span className="px-2">
                                                            <i className="fas fa-stop mr-1" style={{ color: '#0779e4' }}></i>Stable
                                                    </span>
                                                        <span className="px-2">
                                                            <i className="fas fa-stop mr-1" style={{ color: '#a6cb12' }}></i>Trending Up
                                                    </span>
                                                        <span className="px-2">
                                                            <i className="fas fa-stop mr-1" style={{ color: '#d32626' }}></i>Trending Down
                                                    </span>
                                                    </div>
                                                </div>
